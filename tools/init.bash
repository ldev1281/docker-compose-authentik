...
prompt_for_configuration() {
    ...
    read -p "AUTHENTIK_EMAIL__PASSWORD [${AUTHENTIK_EMAIL__PASSWORD:-}]: " input
    AUTHENTIK_EMAIL__PASSWORD=${input:-${AUTHENTIK_EMAIL__PASSWORD:-}}

    read -p "AUTHENTIK_EMAIL__USE_TLS [${AUTHENTIK_EMAIL__USE_TLS:-false}]: " input
    AUTHENTIK_EMAIL__USE_TLS=${input:-${AUTHENTIK_EMAIL__USE_TLS:-false}}
